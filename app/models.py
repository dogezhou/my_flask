...
class User(UserMixin, db.Model):
    ...
    def gravatar(self, size=100, default='identicon', rating='g'):
        ...
        url = 'http://gravatar.duoshuo.com/avatar'  # 使用没有被墙的地址
        # else:
...
class Post(db.Model):
    __tablename__ = 'posts'
    id = db.Column(db.Integer, primary_key=True)
    body = db.Column(db.Text)  # 存储纯 Markdown 文本
